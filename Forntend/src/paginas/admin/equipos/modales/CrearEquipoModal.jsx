...
import { RiCloseLine, RiAddLine, RiFlashlightLine, RiEyeLine, RiEyeOffLine } from "react-icons/ri";
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center space-x-3">
            <div className="bg-yellow-500 p-2 rounded-lg">
              <RiFlashlightLine className="h-5 w-5 text-gray-900" />
            </div>
            <div>
        ...
        <div className="px-6 pb-4">
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3">
            <p className="text-yellow-400 text-xs leading-relaxed">
              ...
              Las fechas de mantenimiento son opcionales y pueden agregarse posteriormente.
            </p>
          </div>
        </div>
