...
import EliminarHorarioModal from "./modales/EliminarHorarioModal";
import {
  RiCalendarLine,
  RiAddLine,
  RiRefreshLine,
...
const Horarios = () => {
  ...
  const [horarioEliminacionTarget, setHorarioEliminacionTarget] = useState(null);
  ...
  const handleCreateHorario = async (horarioData = null) => {
    try {
      const dataToSend = horarioData || {
        ...
        ...(newHorario.id_entrenador &&
          newHorario.id_entrenador !== "" && {
            id_entrenador: parseInt(newHorario.id_entrenador),
          }),
    ...
    <div className="relative z-10 py-8">
      ...
      <div className="mb-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Administra y programa los horarios de entrenamiento
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 text-sm ml-1">
          <span className="text-yellow-400 font-medium">Horarios</span>
        </div>
      </div>
