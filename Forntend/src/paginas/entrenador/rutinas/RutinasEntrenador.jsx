...
const RutinasEntrenador = () => {
  ...
  // CAMBIO IMPORTANTE: Nueva función para crear rutina con arrays JSON
  ...
  // CAMBIO: Actualizar para manejar arrays
    ...
    <div className="relative z-10 py-8">
      ...
      <div className="mb-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Crea rutinas con múltiples ejercicios y administra tus
                entrenamientos
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 text-sm ml-1">
          <span className="text-yellow-400 font-medium">Rutinas</span>
        </div>
      </div>
