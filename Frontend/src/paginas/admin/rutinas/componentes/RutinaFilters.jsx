...
const RutinaFilters = ({ filters, setFilters, musculos }) => {
  ...
  // Función para formatear el label del músculo
  const formatMuscleLabel = (musculo) => {
    // Lista de músculos válidos sin bicep_tricep
    const muscleLabels = {
      'pecho': 'Pecho',
      'espalda': 'Espalda', 
      'pierna': 'Piernas',
    ...
    return muscleLabels[musculo] || musculo.charAt(0).toUpperCase() + musculo.slice(1);
  };
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <SelectFilter
          ...
          options={(musculos || [])
            .filter(musculo => musculo !== 'bicep_tricep') // Filtrar bicep_tricep si existe
            .map((musculo) => ({
              value: musculo,
              label: formatMuscleLabel(musculo),
            }))}
